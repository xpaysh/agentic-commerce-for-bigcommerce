...
export function buildAp2RouteTable(adapter: BigCommerceAdapter, merchantSlug: string): RouteTable<RouteHandler> {
...
function checkoutWithMandate(adapter: BigCommerceAdapter, merchantSlug: string): RouteHandler {
  return async (req): Promise<RouteResponse> => {
